-- Friends System Database Schema - Simple Version
...
-- 2. Create friend requests view (for easier querying) - without equipped_singularity
...
SELECT 
  ...
  'classic-singularity' as requester_avatar,
  ap.display_name as addressee_name,
  ap.username as addressee_username,
  'classic-singularity' as addressee_avatar
...
-- 3. Create friends view (only accepted friendships) - without equipped_singularity
